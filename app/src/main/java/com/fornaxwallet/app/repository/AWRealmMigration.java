    ...
    public void migrate(DynamicRealm realm, long oldVersion, long newVersion) {
        ...
        if (oldVersion == 4) {
            ...
            if (!realmTicker.hasField("currencySymbol"))
                realmTicker.addField("currencySymbol", String.class);
            oldVersion++;
        }
        ...
        if (oldVersion == 5) {
            ...
            if (!realmToken.hasField("lastTxTime"))
                realmToken.addField("lastTxTime", long.class); //add the last transaction update time, used to check tokenscript cached result validity
            oldVersion++;
        }
        ...
        if (oldVersion == 9) {
            ...
            if (!realmToken.hasField("earliestTxBlock"))
                realmToken.addField("earliestTxBlock", long.class);
            oldVersion++;
        }
        ...
        if (oldVersion == 14) {
            ...
            if (!realmToken.hasField("visibilityChanged"))
                realmToken.addField("visibilityChanged", boolean.class);
            oldVersion++;
        }
        ...
        if (oldVersion == 16) {
            ...
            if (!realmToken.hasField("expectedCompletion"))
                realmToken.addField("expectedCompletion", long.class);
        ...
        if (oldVersion == 21) {
            ...
            if (realmData != null && !realmData.hasField("chainId"))
                realmData.addField("chainId", int.class);
            oldVersion++;
        }
        ...
        if (oldVersion == 22) {
            ...
            if (realmData != null && !realmData.hasField("imageOriginalUrl"))
                realmData.addField("imageOriginalUrl", String.class);
            oldVersion++;
        }
        ...
        if (oldVersion == 23) {
            ...
            if (realmData != null && !realmData.hasField("imageThumbnailUrl"))
                realmData.addField("imageThumbnailUrl", String.class);
            oldVersion++;
        }
        ...
        if (oldVersion == 26) {
            ...
            if (realmData != null && !realmData.hasField("balance"))
                realmData.addField("balance", String.class);
            oldVersion++;
        }
        ...
        if (oldVersion == 28) {
            ...
            if (realmData != null && !realmData.hasField("contractAddress"))
                realmData.addField("contractAddress", String.class);
            oldVersion++;
        }
