...
import com.fornaxwallet.app.web3.entity.FunctionCallback;
...
import static com.fornaxwallet.app.entity.tokenscript.TokenscriptFunction.TOKENSCRIPT_CONVERSION_ERROR;
    ...
    private void resolveUserInput() {
        ...
        CalcJsValueCallback cb = new CalcJsValueCallback() {
            ...
            public void calculationCompleted(String value, String result, TokenscriptElement e, Attribute attr) {
                if (BuildConfig.DEBUG)
                    System.out.println("ATTR/FA: Resolve " + value + " : " + result);
                //need to find attr
                ...
                if (e.value.startsWith(TOKENSCRIPT_CONVERSION_ERROR)) //handle parse error
                {
                    ...
                    if (!TextUtils.isEmpty(attr.name))
                        tokenScriptError(getString(R.string.complete_tokenscript_value, attr.name), attr.name);
