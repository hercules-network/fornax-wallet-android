...
import static com.fornaxwallet.app.C.DEFAULT_GAS_LIMIT_FOR_NONFUNGIBLE_TOKENS;
...
import com.fornaxwallet.app.repository.EthereumNetworkBase;
import com.fornaxwallet.app.repository.SignRecord;
import com.fornaxwallet.app.ui.widget.entity.ActionSheetCallback;
import com.fornaxwallet.app.util.StyledStringBuilder;
import com.fornaxwallet.app.viewmodel.WalletConnectViewModel;
import com.fornaxwallet.app.viewmodel.WalletConnectViewModelFactory;
import com.fornaxwallet.app.walletconnect.WCClient;
import com.fornaxwallet.app.walletconnect.WCSession;
import com.fornaxwallet.app.walletconnect.entity.WCEthereumSignMessage;
import com.fornaxwallet.app.walletconnect.entity.WCEthereumTransaction;
import com.fornaxwallet.app.walletconnect.entity.WCPeerMeta;
import com.fornaxwallet.app.walletconnect.entity.WalletConnectCallback;
...
public class WalletConnectActivity extends BaseActivity implements ActionSheetCallback, StandardFunctionInterface, WalletConnectCallback
{
    ...
    private void initWalletConnectPeerMeta()
    {
        ...
        String url = "https://www.fornaxwallet.com";
        String description = viewModel.getWallet().address;
        String[] icons = {C.ALFORNAXWALLET_LOGO_URI};
    ...
    private ActionSheetDialog generateTransactionRequest(Web3Transaction w3Tx, long chainId)
    {
        ...
        try
        {
                    ...
                    || (!w3Tx.recipient.equals(Address.EMPTY) && (w3Tx.payload != null || w3Tx.value != null))) // Raw or Function TX
            {
                ...
                viewModel.calculateGasEstimate(viewModel.getWallet(), com.fornaxwallet.token.tools.Numeric.hexStringToByteArray(w3Tx.payload),
