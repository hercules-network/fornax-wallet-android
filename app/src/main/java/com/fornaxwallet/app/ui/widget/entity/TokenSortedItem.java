...
public class TokenSortedItem extends SortedItem<TokenCardMeta> {
    ...
    public boolean areContentsTheSame(SortedItem newItem) {
        if (viewType == newItem.viewType) {
            ...
            if (debugging)
                System.out.println("DEBUG: Contents: " + weight + " " + newItem.weight + " Balance: " + value.balance + " " + newToken.balance);
            if (weight != newItem.weight) return false;
            else
                return value.balance.equals(newToken.balance) && value.type.ordinal() == newToken.type.ordinal()
        ...
        if (viewType == other.viewType) {
            ...
            if (debugging) {
                if (oldToken == null || newToken == null)
                    ...
                    System.out.println("DEBUG: Item: " + oldToken.tokenId + " " + newToken.tokenId);
            }
