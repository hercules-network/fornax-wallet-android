...
import com.fornaxwallet.app.ui.widget.adapter.TokenScriptManagementAdapter;
import com.fornaxwallet.app.viewmodel.TokenScriptManagementViewModel;
    ...
    public void refreshList(boolean refreshScripts) {
        ...
        viewModel.getTokenLocatorsLiveData().observe(this, new Observer<List<TokenLocator>>() {
            ...
            public void onChanged(List<TokenLocator> tokenList) {
                if (adapter == null)
                    adapter = new TokenScriptManagementAdapter(thisActivity, tokenList, viewModel.getAssetService());
