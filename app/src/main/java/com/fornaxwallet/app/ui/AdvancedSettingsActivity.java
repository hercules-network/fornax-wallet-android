...
import static com.fornaxwallet.app.C.EXTRA_CURRENCY;
import static com.fornaxwallet.app.C.EXTRA_LOCALE;
import static com.fornaxwallet.app.C.EXTRA_STATE;
import static com.fornaxwallet.app.C.PAGE_LOADED;
...
import com.fornaxwallet.app.viewmodel.AdvancedSettingsViewModel;
...
public class AdvancedSettingsActivity extends BaseActivity {
        ...
        switch (requestCode) {
            case HomeActivity.RC_ASSET_EXTERNAL_WRITE_PERM:
                if (viewModel.createDirectory()) {
                    ...
                    showFornaxWalletDirectoryConfirmation();
    ...
    private void showFornaxWalletDirectoryConfirmation() {
