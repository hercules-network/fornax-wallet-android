...
import com.fornaxwallet.app.entity.MediaLinks;
import com.fornaxwallet.app.ui.widget.adapter.HelpAdapter;

import com.fornaxwallet.app.R;
import com.fornaxwallet.app.entity.HelpItem;
import com.fornaxwallet.app.viewmodel.HelpViewModel;
...
public class HelpActivity extends BaseActivity {
    ...
    public void onClick(View v) {
        ...
        com.fornaxwallet.token.tools.TrustAddressGenerator.Request request = new com.fornaxwallet.token.tools.TrustAddressGenerator.Request("0x63cCEF733a093E5Bd773b41C96D3eCE361464942", "z+I6NxdALVtlc3TuUo2QEeV9rwyAmKB4UtQWkTLQhpE=");
        // The Lambda function invocation results in a network call.
        // Make sure it is not called from the main thread.
        new AsyncTask<com.fornaxwallet.token.tools.TrustAddressGenerator.Request, Void, com.fornaxwallet.token.tools.TrustAddressGenerator.Response>() {
            @Override
            protected com.fornaxwallet.token.tools.TrustAddressGenerator.Response doInBackground(com.fornaxwallet.token.tools.TrustAddressGenerator.Request... params) {
            ...
            @Override
            protected void onPostExecute(com.fornaxwallet.token.tools.TrustAddressGenerator.Response response) {
                if (response == null) {
                    return;
                }
