...
import com.fornaxwallet.app.entity.ConfirmationType;
...
import com.fornaxwallet.app.entity.tokenscript.TokenScriptRenderCallback;
import com.fornaxwallet.app.entity.tokenscript.WebCompletionCallback;
...
import com.fornaxwallet.app.repository.entity.RealmTransaction;
import com.fornaxwallet.app.ui.widget.entity.ActionSheetCallback;
import com.fornaxwallet.app.ui.widget.entity.TokenTransferData;
...
import com.fornaxwallet.app.viewmodel.TokenFunctionViewModel;
import com.fornaxwallet.app.viewmodel.TokenFunctionViewModelFactory;
import com.fornaxwallet.app.web3.OnSetValuesListener;
import com.fornaxwallet.app.web3.Web3TokenView;
import com.fornaxwallet.app.web3.entity.Address;
import com.fornaxwallet.app.web3.entity.PageReadyCallback;
...
import com.fornaxwallet.app.widget.ActionSheetMode;
import com.fornaxwallet.app.widget.ChainName;
import com.fornaxwallet.app.widget.EventDetailWidget;
...
import com.fornaxwallet.token.entity.TSActivityView;
import com.fornaxwallet.token.entity.TSTokenView;
...
import static com.fornaxwallet.app.C.ETH_SYMBOL;
import static com.fornaxwallet.app.entity.TransactionDecoder.FUNCTION_LENGTH;
import static com.fornaxwallet.app.service.AssetDefinitionService.ASSET_DETAIL_VIEW_NAME;
import static com.fornaxwallet.app.ui.widget.holder.TransactionHolder.TRANSACTION_BALANCE_PRECISION;
        ...
        pendingTxUpdate = Observable.interval(0, 1, TimeUnit.SECONDS)
                .doOnNext(l -> {
                    runOnUiThread(() -> {
                        ...
                        if (pendingText != null)
                            pendingText.setText(getString(R.string.transaction_pending_for, Utils.convertTimePeriodInSeconds(pendingTimeInSeconds, this)));
                        checkForUpdate();
                    });
                }).subscribe();
    }
