...
import static com.fornaxwallet.app.C.ADDED_TOKEN;
import static com.fornaxwallet.app.C.CHANGED_LOCALE;
import static com.fornaxwallet.app.C.CHANGE_CURRENCY;
import static com.fornaxwallet.app.C.RESET_TOOLBAR;
import static com.fornaxwallet.app.C.RESET_WALLET;
import static com.fornaxwallet.app.entity.WalletPage.ACTIVITY;
import static com.fornaxwallet.app.entity.WalletPage.DAPP_BROWSER;
import static com.fornaxwallet.app.entity.WalletPage.SETTINGS;
import static com.fornaxwallet.app.entity.WalletPage.WALLET;
...
import com.fornaxwallet.app.entity.HomeCommsInterface;
import com.fornaxwallet.app.entity.HomeReceiver;
...
import com.fornaxwallet.app.ui.widget.entity.ScrollControlViewPager;
import com.fornaxwallet.app.util.LocaleUtils;
import com.fornaxwallet.app.util.RootUtil;
import com.fornaxwallet.app.util.UpdateUtils;
import com.fornaxwallet.app.util.Utils;
import com.fornaxwallet.app.viewmodel.BaseNavigationActivity;
import com.fornaxwallet.app.viewmodel.HomeViewModel;
import com.fornaxwallet.app.viewmodel.HomeViewModelFactory;
import com.fornaxwallet.app.walletconnect.WCSession;
import com.fornaxwallet.app.widget.AWalletAlertDialog;
import com.fornaxwallet.app.widget.AWalletConfirmationDialog;
        ...
        FragmentMessenger, Runnable, SignAuthenticationCallback, LifecycleObserver
{
    ...
    {
        Log.d("LIFE", "FornaxWallet into foreground");
    ...
    {
        Log.d("LIFE", "FornaxWallet into background");
    ...
    private void checkWarnings()
    {
        if (updatePrompt)
        {
            ...
            if (warns < 3)
            {
                ...
                cDialog.setTitle(R.string.fornaxwallet_update);
                cDialog.setCancelable(true);
                cDialog.setSmallText("Using an old version of FornaxWallet. Please update from the Play Store or FornaxWallet website.");
