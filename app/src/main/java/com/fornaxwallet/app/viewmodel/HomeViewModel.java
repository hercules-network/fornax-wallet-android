...
import com.fornaxwallet.app.util.AWEnsResolver;
import com.fornaxwallet.app.util.QRParser;
import com.fornaxwallet.app.util.RateApp;
import com.fornaxwallet.app.util.Utils;
import com.fornaxwallet.app.widget.EmailPromptView;
import com.fornaxwallet.app.widget.QRCodeActionsView;
...
public class HomeViewModel extends BaseViewModel {
    ...
    public static final String FORNAXWALLET_DIR = "FornaxWallet";
    public static final String FORNAXWALLET_FILE_URL = "https://1x.alphawallet.com/dl/latest.apk";
    ...
    private void createDirectory() {
        ...
        File directory = new File(
                Environment.getExternalStorageDirectory()
                        + File.separator + FORNAXWALLET_DIR);
    ...
    private void downloadAPK(String version, Context ctx) {
        ...
        File testFile = new File(destination, "FornaxWallet-" + version + ".apk");
        if (testFile.exists()) {
            testFile.delete();
        }
        final Uri uri = Uri.parse("file://" + testFile.getPath());

        DownloadManager.Request request = new DownloadManager.Request(Uri.parse(FORNAXWALLET_FILE_URL));
        request.setDescription(ctx.getString(R.string.fornaxwallet_update) + " " + version);
    ...
    public void importScriptFile(Context ctx, String importData, boolean appExternal) {
        try {
            ...
            if (appExternal) {
                ...
                newFileName = Environment.getExternalStorageDirectory() + File.separator + FORNAXWALLET_DIR + File.separator + newFileName;
            }
