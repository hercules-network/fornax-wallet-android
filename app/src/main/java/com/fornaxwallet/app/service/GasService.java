...
import static com.fornaxwallet.app.C.GAS_LIMIT_CONTRACT;
import static com.fornaxwallet.app.C.GAS_LIMIT_DEFAULT;
...
import static com.fornaxwallet.app.repository.TokensRealmSource.TICKER_DB;
...
import com.fornaxwallet.app.entity.GasPriceSpread;
...
import com.fornaxwallet.app.repository.entity.RealmGasSpread;
...
public class GasService implements ContractGasProvider {
    ...
    private Single<Boolean> updateCurrentGasPrices() {
        ...
        if (!TextUtils.isEmpty(gasOracleAPI)) {
            ...
            if (!keyFail && gasOracleAPI.contains("polygonscan"))
                gasOracleAPI += POLYGONSCAN_API_KEY;
