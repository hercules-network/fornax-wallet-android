...
public class FornaxWalletFirebaseMessagingService {
}
/*public class FornaxWalletFirebaseMessagingService extends FirebaseMessagingService {
    public static final String TAG = FornaxWalletFirebaseMessagingService.class.getSimpleName();
