...
import com.fornaxwallet.token.util.DateTime;
import com.fornaxwallet.token.util.DateTimeFactory;
        ...
        switch (getAs()) {
            ...
            case Mapping:
                ...
                if (members != null && members.containsKey(data)) {
                    ...
                    //refer to 'FornaxWallet meetup indices' where 'Match' mapping is null but for FIFA is not.
