package com.fornaxwallet.token.web;
...
import com.fornaxwallet.token.entity.MagicLinkInfo;
import com.fornaxwallet.token.entity.NonFungibleToken;
import com.fornaxwallet.token.entity.SalesOrderMalformed;
import com.fornaxwallet.token.entity.XMLDsigVerificationResult;
...
import com.fornaxwallet.token.tools.XMLDSigVerifier;
import com.fornaxwallet.token.web.Ethereum.TokenscriptFunction;
import com.fornaxwallet.token.web.Ethereum.TransactionHandler;
import com.fornaxwallet.token.web.Service.CryptoFunctions;
import static com.fornaxwallet.token.tools.Convert.getEthString;
import static com.fornaxwallet.token.tools.ParseMagicLink.normal;
import static com.fornaxwallet.token.web.Ethereum.TokenscriptFunction.ZERO_ADDRESS;
...
public class AppSiteController implements AttributeInterface {
    ...
    public TransactionResult storeAuxData(String wAddress, TransactionResult tResult) {
        ...
        if (!transactionResults.containsKey(tResult.contractChainId))
            transactionResults.put(tResult.contractChainId, new HashMap<>());
        if (!transactionResults.get(tResult.contractChainId).containsKey(addressFunctionKey))
            transactionResults.get(tResult.contractChainId).put(addressFunctionKey, new HashMap<>());
